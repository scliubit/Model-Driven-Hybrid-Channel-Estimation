...
if __name__ == '__main__':
    ...
    D = np.load('ULAtraindata256_64.mat', allow_pickle=True)
    N_BS = 256  # 基站天线数
    G = 1024
    K = 64    # 载波数
    L = 8    # 路径数
    maxiter = 100  # iter_number
    BW = 30.72e6  # 系统带宽
    fs = BW
    fc = 30e9
    tau_max = 0.2e-6
    ...
    save_problem('ULAtraindata' + str(N_BS) + '_' + str(K), genPro)
